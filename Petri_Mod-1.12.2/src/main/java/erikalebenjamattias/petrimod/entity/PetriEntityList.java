...
public class PetriEntityList {
	...
	/**
	 * Called in the FMLInitializationEvent of the main mod class ({@link PetriMod}.java) to actually register the entities.
	 */
	...
	public static void registerEntity() {
		...
		createEntity(new ResourceLocation(Reference.MOD_ID + ":front_clock"), EntityFrontClock.class, "FrontClock", 128, 2);
	}
