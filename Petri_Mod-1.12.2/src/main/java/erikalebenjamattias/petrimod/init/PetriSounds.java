...
public class PetriSounds {
	...
	public static void init() {
		...
		ENTIY_GRAND_PIANO_A0 = new SoundEvent(entity_grand_piano_a0).setRegistryName(entity_grand_piano_a0);
		
		ENTIY_GRAND_PIANO_C1 = new SoundEvent(entity_grand_piano_c1).setRegistryName(entity_grand_piano_c1);
		ENTIY_GRAND_PIANO_Dsharp1 = new SoundEvent(entity_grand_piano_dsharp1).setRegistryName(entity_grand_piano_dsharp1);
		ENTIY_GRAND_PIANO_Fsharp1 = new SoundEvent(entity_grand_piano_fsharp1).setRegistryName(entity_grand_piano_fsharp1);
		ENTIY_GRAND_PIANO_A1 = new SoundEvent(entity_grand_piano_a1).setRegistryName(entity_grand_piano_a1);
		
		ENTIY_GRAND_PIANO_C2 = new SoundEvent(entity_grand_piano_c2).setRegistryName(entity_grand_piano_c2);
		ENTIY_GRAND_PIANO_Dsharp2 = new SoundEvent(entity_grand_piano_dsharp2).setRegistryName(entity_grand_piano_dsharp2);
		ENTIY_GRAND_PIANO_Fsharp2 = new SoundEvent(entity_grand_piano_fsharp2).setRegistryName(entity_grand_piano_fsharp2);
		ENTIY_GRAND_PIANO_A2 = new SoundEvent(entity_grand_piano_a2).setRegistryName(entity_grand_piano_a2);
		
		ENTIY_GRAND_PIANO_C3 = new SoundEvent(entity_grand_piano_c3).setRegistryName(entity_grand_piano_c3);
		ENTIY_GRAND_PIANO_Dsharp3 = new SoundEvent(entity_grand_piano_dsharp3).setRegistryName(entity_grand_piano_dsharp3);
		ENTIY_GRAND_PIANO_Fsharp3 = new SoundEvent(entity_grand_piano_fsharp3).setRegistryName(entity_grand_piano_fsharp3);
		ENTIY_GRAND_PIANO_A3 = new SoundEvent(entity_grand_piano_a3).setRegistryName(entity_grand_piano_a3);
		
		ENTIY_GRAND_PIANO_C4 = new SoundEvent(entity_grand_piano_c4).setRegistryName(entity_grand_piano_c4);
		ENTIY_GRAND_PIANO_Dsharp4 = new SoundEvent(entity_grand_piano_dsharp4).setRegistryName(entity_grand_piano_dsharp4);
		ENTIY_GRAND_PIANO_Fsharp4 = new SoundEvent(entity_grand_piano_fsharp4).setRegistryName(entity_grand_piano_fsharp4);
		ENTIY_GRAND_PIANO_A4 = new SoundEvent(entity_grand_piano_a4).setRegistryName(entity_grand_piano_a4);
		
		ENTIY_GRAND_PIANO_C5 = new SoundEvent(entity_grand_piano_c5).setRegistryName(entity_grand_piano_c5);
		ENTIY_GRAND_PIANO_Dsharp5 = new SoundEvent(entity_grand_piano_dsharp5).setRegistryName(entity_grand_piano_dsharp5);
		ENTIY_GRAND_PIANO_Fsharp5 = new SoundEvent(entity_grand_piano_fsharp5).setRegistryName(entity_grand_piano_fsharp5);
		ENTIY_GRAND_PIANO_A5 = new SoundEvent(entity_grand_piano_a5).setRegistryName(entity_grand_piano_a5);
		
		ENTIY_GRAND_PIANO_C6 = new SoundEvent(entity_grand_piano_c6).setRegistryName(entity_grand_piano_c6);
		ENTIY_GRAND_PIANO_Dsharp6 = new SoundEvent(entity_grand_piano_dsharp6).setRegistryName(entity_grand_piano_dsharp6);
		ENTIY_GRAND_PIANO_Fsharp6 = new SoundEvent(entity_grand_piano_fsharp6).setRegistryName(entity_grand_piano_fsharp6);
		ENTIY_GRAND_PIANO_A6 = new SoundEvent(entity_grand_piano_a6).setRegistryName(entity_grand_piano_a6);
		
		ENTIY_GRAND_PIANO_C7 = new SoundEvent(entity_grand_piano_c7).setRegistryName(entity_grand_piano_c7);
		ENTIY_GRAND_PIANO_Dsharp7 = new SoundEvent(entity_grand_piano_dsharp7).setRegistryName(entity_grand_piano_dsharp7);
		ENTIY_GRAND_PIANO_Fsharp7 = new SoundEvent(entity_grand_piano_fsharp7).setRegistryName(entity_grand_piano_fsharp7);
		ENTIY_GRAND_PIANO_A7 = new SoundEvent(entity_grand_piano_a7).setRegistryName(entity_grand_piano_a7);
		
		ENTIY_GRAND_PIANO_C8 = new SoundEvent(entity_grand_piano_c8).setRegistryName(entity_grand_piano_c8);
	}
	
	public static void register(final RegistryEvent.Register<SoundEvent> event) {
		event.getRegistry().registerAll(
    		ENTIY_GRAND_PIANO_A0,
    		
    		ENTIY_GRAND_PIANO_C1,
    		ENTIY_GRAND_PIANO_Dsharp1,
    		ENTIY_GRAND_PIANO_Fsharp1,
    		ENTIY_GRAND_PIANO_A1,
    		
    		ENTIY_GRAND_PIANO_C2,
    		ENTIY_GRAND_PIANO_Dsharp2,
    		ENTIY_GRAND_PIANO_Fsharp2,
    		ENTIY_GRAND_PIANO_A2,
    		
    		ENTIY_GRAND_PIANO_C3,
    		ENTIY_GRAND_PIANO_Dsharp3,
    		ENTIY_GRAND_PIANO_Fsharp3,
    		ENTIY_GRAND_PIANO_A3,
    		
    		ENTIY_GRAND_PIANO_C4,
    		ENTIY_GRAND_PIANO_Dsharp4,
    		ENTIY_GRAND_PIANO_Fsharp4,
    		ENTIY_GRAND_PIANO_A4,
    		
    		ENTIY_GRAND_PIANO_C5,
    		ENTIY_GRAND_PIANO_Dsharp5,
    		ENTIY_GRAND_PIANO_Fsharp5,
    		ENTIY_GRAND_PIANO_A5,
    		
    		ENTIY_GRAND_PIANO_C6,
    		ENTIY_GRAND_PIANO_Dsharp6,
    		ENTIY_GRAND_PIANO_Fsharp6,
    		ENTIY_GRAND_PIANO_A6,
    		
    		ENTIY_GRAND_PIANO_C7,
    		ENTIY_GRAND_PIANO_Dsharp7,
    		ENTIY_GRAND_PIANO_Fsharp7,
    		ENTIY_GRAND_PIANO_A7,
    		
    		ENTIY_GRAND_PIANO_C8
        );
	}
}
